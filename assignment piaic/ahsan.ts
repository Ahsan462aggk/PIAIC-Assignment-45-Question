// problem 1
let Name:string="Hello Eric"

let message:string=`${Name} Would you like to lern phyton\n`

console.log(message)

//problem 2

let userName:string="Hello Eric"

let personalMessage:string=`${Name} Would you like to lern phyton`
...
let aurthurName:string="Albert einstein once said,";
...
let friends:string[]=["Ahsan","shais","Nabeel"];
...
let friend:string[]=["Ahsan","shais","Nabeel"];
for(let i=0;i<friends.length;i++){
...
let trans:string[]=["honda","toyota","yamaha","suzuki"]
...
let guest:string[]=["Uncle","cousin","Grand uncle"]
console.log(guest);
...
let guests:string[]=["Uncle","Cousin","Grand uncle"];
console.log(guests);
...
// problem 16:
   ...
   console.log(`Good news! we have more space at dinner table. i have to think to invite three more guest\n`)
    ...
    let worldPlace:string[]=["Saudi Arbia","UAE","Canada","England","Qatar"]

    console.log("\t\tOriginal order\t") 
    console.log(worldPlace)
    // print array in original order

    const array:string[]= worldPlace.slice()
    ...
    //problem 20
     let list:string[]=["faislabad","lahore","peshawar","islamabad","karachi"]
     ...
     let Userprofile2:obj={
        userName:"Shais",
        id: 23455,
        address:"karachi"
}
let Userprofile3:obj={
    userName:"Nabeel",
    id: 4245,
    address:"peshawar"
}
let data:obj[]=[userProfile,Userprofile2,Userprofile3];
for(let i=0;i<3;i++){
console.log(data[i])
}
...
let array1:string[]=["cricket","football","badmintion","hockey"];
//creating an array
let invalidIndex=45;
// invalid index
...
let string1:string="shaheed"
let string2:string="Shaheed"
...
let arrayTest:string[]=["ahsan","shais","saeed"]
...
let favourite_fruits:string[]=["apple","pineapple","banana"]
// favourite fruits
for(let i=0;i<3;i++){
...
//problem 30
let userNames:string[]=["admin","Eric","saeed","nabeel","shais"]
...
// if the list is empty print amessage user need to find some user
   ...
   let current_users:string[]=["ahsan","shais","sherz","ahmad","nabeel"]
 
   let new_users:string[]=["shais","saeed","hammad","haroon","nabeel"]
...
//problem 34
let pizza:string[]=["Chicago pizza","Margrehita pizza","pepperonzi pizza"]
for (let i=0;i<3;i++)
{
   console.log(pizza[i])
...
function city_coutry(cities:string,country:string)
{
...
{artistname:string ,albumTitle:string,track?:number  
}
{
   const album={
      artistname,
...
let magician:string[]=["abrar ahmed","abdullah","rehman"]
...
//problem 43
let magicians:string[]=["abrar ahmed","abdullah","rehman"]
// array of magician names
...
function cars(manufactured:string,model:string,...properties:[string,any][]):any{
